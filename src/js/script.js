const descriptionSkills = {
  ...
  nodejs: {
    en: `I use <strong>Node.js</strong> to develop the <strong>backend</strong> of my applications, with an emphasis on creating efficient and scalable <strong>RESTful APIs</strong>. With <strong>Express</strong>, I structure the server in an organized and modular way, applying good coding practices to guarantee the <strong>maintainability</strong> and <strong>security</strong> of the code. I value the implementation of robust functionalities, such as <strong>authentication</strong>, data <strong>validation</strong> and <strong>route manipulation</strong>, always seeking to optimize the performance and scalability of APIs.
              `,
    pt: `Utilizo <strong>Node.js</strong> para desenvolver o <strong>backend</strong> das minhas aplicações,
              com ênfase na criação de <strong>APIs RESTful</strong> eficientes e escaláveis. Com
              <strong>Express</strong>, estruturo o servidor de forma organizada e modular,
              aplicando boas práticas de codificação para garantir a
              <strong>manutenibilidade</strong> e <strong>segurança</strong> do código. Valorizo a implementação
              de funcionalidades robustas, como <strong>autenticação</strong>, <strong>validação</strong> de dados
              e <strong>manipulação de rotas</strong>, sempre buscando otimizar o desempenho e a
  ...
  sql: {
    en: `I use <strong>SQL</strong> to manage and manipulate data in
              relational databases. I value building well-designed database
              structures, with an emphasis on <strong>normalization</strong> and
              <strong>referential integrity</strong>, to ensure the consistency
              and efficiency of information. I take advantage of the SQL
              language to <strong>create</strong>, <strong>read</strong>,
              <strong>update</strong> and <strong>delete</strong> data
              <strong>(CRUD)</strong>, in addition to implementing
              <strong>joins</strong>, aggregations and subqueries to extract
              valuable insights.
            `,
